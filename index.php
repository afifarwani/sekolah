...
<head>
	...
	<title>Home - Kampung Sholawat</title>
	...
	<div class="container bg-light">
		...
		<div class="logo clearfix">
			<div class="float-left mt-3 mb-3">
				<img src="resources/images/2.png" alt="Logo Sekolah" width="70px" class="float-left mr-3">
				<div class="text float-right">
					<span class="smk">Kampung Sholawat</span><br>
					<span class="visi">Berjamaah di dalam masjid dan berjamaah di luar masjid.</span>
				</div>
			</div>
		</div>
